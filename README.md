...
The logo of the project is a placeholder (docs/images/icon-nornir-nautobot.png) - please replace it with your app icon, making sure it's at least 200x200px and has a transparent background!
...
Full documentation for this library can be found over on the [Nornir Nautobot Docs](https://nornir-nautobot.readthedocs.io/) website:

- [User Guide](https://nornir-nautobot.readthedocs.io/en/latest/user/app_overview/) - Overview, Using the Library, Getting Started.
...
You can find all the Markdown source for the App documentation under the [`docs`](https://github.com/nautobot/nornir-nautobot/tree/develop/docs) folder in this repository. For simple edits, a Markdown capable editor is sufficient: clone the repository and edit away.

If you need to view the fully-generated documentation site, you can build it with [MkDocs](https://www.mkdocs.org/). A container hosting the documentation can be started using the `invoke` commands (details in the [Development Environment Guide](https://nornir-nautobot/dev/dev_environment/#docker-development-environment)) on [http://localhost:8001](http://localhost:8001). Using this container, as your changes to the documentation are saved, they will be automatically rebuilt and any pages currently being viewed will be reloaded in your browser.
