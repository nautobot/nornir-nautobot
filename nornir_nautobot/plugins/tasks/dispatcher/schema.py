...
api_resources = [
    ...
    },
    {
        ...
        "keys": [
            "enabled", "primary-ntp", "secondary-ntp",
            "server-dns-names", "mode", "poll-interval",
            "active-server"
            ],
        "unique": "",
        "unique_together": (),
        ...
        "endpoint": "/ip/dns",
        "keys": [
            "servers", "dynamic-servers", "use-doh-server"
            ],
        "unique": "",
        "unique_together": (),
        ...
        "keys": [
            "id", "name", "addresses", "security",
            "read-access", "write-access", "default",
            "disabled"
            ],
        "unique": "",
        "unique_together": (),
        ...
        "keys": [
            "id", "name", "target", "remote",
            "remote-port", "src-address", "bsd-syslog",
            "syslog-time-format", "syslog-facility",
